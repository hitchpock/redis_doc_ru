...
**GETBIT** просто возвращает значение бита по указанному индексу. Биты вне диапазона (адресация бита, который находится за пределами длины строки, сохраненной в ключе) всегда считаются равными нулю.
